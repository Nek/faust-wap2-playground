...
export default class PluginLoader {
    ...
    async load() {
        try {
            ...
            let real_url = (this.baseURL === "") ? "melody.wasm" : (this.baseURL + "/melody.wasm");
            ...
            this.node.onprocessorerror = () => { console.log('An error from melody-processor was detected.'); }
            return (this.node);
        } catch (e) {
            console.error(e);
            console.error("Faust " + this.name + " cannot be loaded or compiled");
            ...
            try {
                ...
                if (!this.linkExists(real_url)) {
                    ...
                    link.onload = (e) => {
                        ...
                        var element = createmelodyGUI(this.node);
                        resolve(element);
                    }
                } else {
